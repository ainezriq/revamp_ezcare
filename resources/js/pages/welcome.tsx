...
export default function Welcome() {
    ...
    const images = [
        { src: 'new_general_banner.jpg', alt: 'Banner 1' },
    ];
...
const statements = [
    {
      name: "ND EXPERT",
      text: "Claimed for my EZ CARE warranty. Excellent response and reliable for those who want to have an extra warranty for their recond car purchased. TQ kauthar and EZ CARE 👍",
      rating: 5,
    },
    {
      name: "Meor",
      text: "Very responsive. Quick response for warranty claim. Keep it up. Great customer experience with EZcare Warranty",
      rating: 5,
    },
    {
      name: "Mohamad Fazli Sainal",
      text: "Dashborad error Brake System Multifunctional. Go to workshop Zordaq Motorsports Bdr Puteri Bangi, Scan n Dignosed shown Alternator problem. Claim with EZ Care due to within warranty, very Helpful staff, Good CRM and Fast Reply. Well entertain & keep it up!",
      rating: 5,
    },
    {
      name: "Kenny Voon",
      text: "My vellfire under warranty by ezcare - show the check engine light. Sent to Euroauto in Kuching and diagnosed is EGR issue. Submitted to Ezcare for warranty claim. After one week submission with some request of docs, claim was approved. Reliable! Will trust ezcare!",
      rating: 5,
    },
    {
      name: "Kent Chong",
      text: "My car have a 5 years warranty with ezcare. This is last year before expired the warranty. My car had a problem with gearbox. Ezcare warranty settle my gearbox problem. I am very happy cause claim process very easy & fast. I am very satisfied with ezcare warranty",
      rating: 5,
    },
    {
      name: "ST Looi",
      text: "Thanks EZcare warranty for fast response and fast claim approval",
      rating: 5,
    },
    {
      name: "Azman Mohd Zobi",
      text: "Very good, responsive and responsible, helping the customer at the best they can.",
      rating: 4,
    },
  ];
            ...
            <div className="min-h-screen bg-[#FDFDFC] text-[#1b1b18] dark:bg-[#0a0a0a]">
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0 pt-16">
                    <main className="flex w-full flex-col-reverse lg:flex-row">
                        ...
                        <div 
                            className="relative w-full overflow-hidden rounded-lg bg-[#fff2f2] dark:bg-[#1D0002]"
                            style={bannerSize ? { aspectRatio: `${bannerSize.width} / ${bannerSize.height}` } : { aspectRatio: '3 / 1' }}
                            onTouchStart={handleTouchStart}
                            onTouchMove={handleTouchMove}
                            onTouchEnd={handleTouchEnd}
                        >
      ...
      <div className="flex space-x-4 justify-center">
        ...
        <a href="https://appgallery.huawei.com/app/C109957695" aria-label="Huawei AppGallery">
          <img src="/appgallery-badge.jpg" alt="AppGallery" className="h-12 rounded-lg" />
                ...
                <SatisfactionSection statements={statements} />
